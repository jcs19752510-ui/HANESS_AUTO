...
### Step 3 — 처음 한 번만 목표를 자세히 요청 (이게 끝이다)
특별한 명령어 문법은 없다. 그냥 대화하듯, 최대한 구체적으로 한 번 말하면 된다.

> 예시: "1단계부터 쭉 진행해줘. 도메인은 소규모 학원 출결관리 서비스야. 타깃은 학원 원장님들. 정말 판단이 필요한 질문이나 배포 승인 시점 아니면 멈추지 말고 계속 이어서 진행해줘."
